...
// 		}
		...
		$form_fields[] = $form_field;
		$form_field = array("name"=>"admitting_doctor", "content"=>"admitting doctor", "readonly"=>"",  "required"=>"required", "type"=>"text","class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"bed_type", "content"=>"bed type", "readonly"=>"",  "required"=>"required", "type"=>"select", "options"=>array("MARRIED"=>"MARRIED","SINGLE"=>"SINGLE"), "class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"ward", "content"=>"ward", "readonly"=>"",  "required"=>"required", "type"=>"select", "options"=>array("MARRIED"=>"MARRIED","SINGLE"=>"SINGLE"), "class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"bed_name", "content"=>"bed name", "readonly"=>"",  "required"=>"required", "type"=>"select", "options"=>array("MARRIED"=>"MARRIED","SINGLE"=>"SINGLE"), "class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"duty_doctor", "content"=>"duty doctor", "readonly"=>"",  "required"=>"required", "type"=>"select", "options"=>array("MARRIED"=>"MARRIED","SINGLE"=>"SINGLE"), "class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"is daycare", "content"=>"is daycare", "readonly"=>"",  "required"=>"required", "type"=>"checkbox", "options"=>array(),  "class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"beds_available", "content"=>"beds available", "readonly"=>"",  "required"=>"required", "type"=>"text","class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"charge", "content"=>"charge", "readonly"=>"",  "required"=>"required", "type"=>"text","class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"initial_amount", "content"=>"initial amount", "readonly"=>"",  "required"=>"required", "type"=>"text","class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"referredby", "content"=>"referred by", "readonly"=>"",  "required"=>"required", "type"=>"text","class"=>"form-control");
		$form_fields[] = $form_field;
		$form_field = array("name"=>"complaint", "content"=>"complaint", "readonly"=>"",  "required"=>"required", "type"=>"text","class"=>"form-control");
		$form_fields[] = $form_field;
	 ...
	 * @return Response
	 */
	public function editInpatients()
	{
		$values = Input::all();
		$values["Sdf"];
		if (\Request::isMethod('post'))
...
// 			$form_fields[] = $form_field;
	 ...
	 * @return Response
	 */
	public function manageInpatients()
	{
		$values = Input::all();
		$values['bredcum'] = "PATIENTS";
		$values['home_url'] = 'masters';
		$values['add_url'] = 'addinpatient';
		$values['form_action'] = 'inpatients';
		$values['action_val'] = '';
