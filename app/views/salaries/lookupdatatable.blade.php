	...
	@section('inline_js')
		...
		<script type="text/javascript">
			...
			function getendreading(){
				...
				$.ajax({
				      url: "getendreading?id="+1+"&date="+date,
				      success: function(data) {
				...
				if(emptype=="office"){
					$.ajax({
					      url: "getemployeesbyoffice?officebranch="+officebranch+"&date="+date,
					      success: function(data) {
					...
					$.ajax({
				      url: "getemployeesbydepot?depot="+depot+"&clientname="+clientname+"&date="+date,
				      success: function(data) {
					     $("#employeename").html(data);
					     $('.chosen-select').trigger('chosen:updated');
				      },
			...
			function getEmployeesByOffice(id){
				date = $("#date").val();
				$.ajax({
			      url: "getemployeesbyoffice?branch="+id+"&date="+date,
			      success: function(data) {
				     $("#employeename").html(data);
				     $('.chosen-select').trigger('chosen:updated');
			      },
			...
			function getEmployeesByDepot(id){
				...
				date = $("#date").val();
				$.ajax({
			      url: "getemployeesbydepot?depot="+id+"&clientname="+clientname+"&date="+date,
			      success: function(data) {
				     $("#employeename").html(data);
				     $('.chosen-select').trigger('chosen:updated');
			      },
