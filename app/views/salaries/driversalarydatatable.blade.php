					...
					<thead>
						...
						<?php
							...
							<tr>
								...
								<?php 
									...
									if(($entity->terminationDate!="" && $entity->terminationDate!="0000-00-00" && $date2!="01-01-1970"  && $date2>=$date3 &&  $date2<$date4)){
										...
										$date2_=date_create(date("Y-m-d",strtotime($entity->terminationDate)));
										$diff=date_diff($date3_,$date2_);
										//echo $entity->terminationDate."and ".print_r($diff)."-";
										$early_erminated_days =  $diff->format("%a");
										//echo "early terminated days".$early_erminated_days."-";
										$early_erminated_days = $early_erminated_days+1;
										$actual_working_days = $early_erminated_days;
										$net_salary = ($salary_amt/$total_days)*$actual_working_days;
							...
							<tr>
								...
								<td style="vertical-align: middle;">
									<input type="text" style="max-width:70px; vertical-align: middle;"  name="due_deductions[]" id="{{$i}}_due_deductions" onchange="calcSalary(this.id)" value="{{$rec->dueDeductions}}"/>	
								</td>
								<td style="vertical-align: middle;">
									<input type="text" style="max-width:70px; vertical-align: middle;" name="leave_deductions[]" id="{{$i}}_leave_deductions" onchange="calcSalary(this.id)" value="{{$rec->leaveDeductions}}"/>	
								</td>
								<td style="vertical-align: middle">
									<input type="text" style="max-width:70px;vertical-align: middle;" name="other_deductions[]" id="{{$i}}_other_deductions" onchange="calcSalary(this.id)" value="{{$rec->otherDeductions}}"/>	
								</td>
								<td style="vertical-align: middle;">
									<select name="pfopted[]" id="pfopted_{{$i}}" class="form-control" >
										<option value="Yes">Yes</option>
