...
// 									}
		...
		<div class="row">
			<div class="col-xs-12" style="max-width: 98%;margin-left: 12px;">
				...
				<?php 
					$values = Input::All();
					if(isset($values["month"]) && isset($values["fromdate"])){		
				?>	
					...
					<thead>
						...
						<?php
							...
							<tr>
								...
								<td style="vertical-align: middle">
									<input type="text" style="max-width:70px;" name="other_deductions[]" id="{{$i}}_other_deductions" onchange="calcSalary(this.id)" value="0.00"/>	
								</td>
								<td style="vertical-align: middle">
									<select name="pfopted[]" id="pfopted_{{$i}}" class="form-control" >
										<option value="Yes">Yes</option>
	...
	@section('inline_js')
		...
		<script type="text/javascript">
			...
			function saveRecord(rowid, eid,type){
				...
				other_dedutions = $("#"+rowid+"_other_deductions").val();
