@extends('masters.master')
			...
			<div id="table1">
				<div class="row col-xs-12" style="padding-left:2%; padding-top: 1%">
					...
					<div class="table-header" style="margin-top: 10px;">
						<span>Results for REPORT2</span><span id="headval"><span style="float:right;font-weight: bold;">Total Gross : <span id="tot_gross">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;Total Tds : <span id="tot_tds">0.00</span>&nbsp;&nbsp;&nbsp;Total Emi : <span id="tot_emi">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;OD : <span id="tot_od">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;Total Net : <span id="tot_net">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
					</div>
	...
	@section('inline_js')
		...
		<script type="text/javascript">
			...
			function getData(clientId,month,fromdate, todate){
				//$("#headval").html(name);
				//alert(clientId+","+month+","+fromdate+","+todate);

				var myin = document.createElement("input"); 
				myin.type='hidden'; 
				myin.name='reporttype1'; 
				myin.id ='reporttype1';
				myin.value="bill_details"; 
