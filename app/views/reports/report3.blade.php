			...
			<div id="table1">
				<div class="row col-xs-12" style="padding-left:2%; padding-top: 1%">
					...
					<div class="table-header" style="margin-top: 10px;">
						<span>Results for REPORT3</span><span id="headval"></span> <span style="float:right;font-weight: bold;">Total Gross : <span id="tot_gross">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;Total Tds : <span id="tot_tds">0.00</span>&nbsp;&nbsp;&nbsp;Total Emi : <span id="tot_emi">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;OD : <span id="tot_od">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;Total Net : <span id="tot_net">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;Client Paid : <span id="tot_client">0.00</span>&nbsp;&nbsp;&nbsp;&nbsp;Balance : <span id="tot_bal">0.00</span>&nbsp;&nbsp;&nbsp;</span>
					</div>
			...
			function paginate(page){
				...
				$.ajax({
			        ...
			        success: function(response){
			           ...
			           tot_gross = json["tot_gross"];
			        	tot_tds = json["tot_tds"];
			        	tot_emi = json["tot_emi"];
			        	tot_od = json["tot_od"];
			        	tot_net = json["tot_net"];
			        	tot_client = json["tot_client"];
			        	tot_bal = json["tot_bal"]
		        		$("#tot_gross").html(tot_gross);
			        	$("#tot_tds").html(tot_tds);
			        	$("#tot_emi").html(tot_emi);
			        	$("#tot_od").html(tot_od);
			        	$("#tot_net").html(tot_net);
			        	$("#tot_client").html(tot_client);
			        	$("#tot_bal").html(tot_bal);
