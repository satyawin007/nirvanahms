@extends('masters.master')
	...
	@section('inline_js')
		...
		<script type="text/javascript">
			...
			function changeLoan(val){
				$.ajax({
			      url: "getfinance?loantype="+val,
			      success: function(data) {
			...
			function paginate(page){
				...
				$.ajax({
			        ...
			        success: function(response){
			           ...
			           if((reportfor == "loan_payment" || reportfor == "interest_payment") && loantype == "unsecure_loans"){
							myTable3.clear().draw();
			           ...
			           if((reportfor == "loan_payment" || reportfor == "interest_payment") && loantype == "secure_loans"){
							myTable1.clear().draw();
