			...
			<div id="table1">
				<div class="row col-xs-12" style="padding-left:2%; padding-top: 1%">
					...
					<div class="table-header" style="margin-top: 10px;">
						...
						<span style="float:right; font-size: 16px; font-weight: bold;">Paid by card : <span id="dbamt">0.00</span>  &nbsp;&nbsp;&nbsp;Paid to card : <span id="pdamt">0.00</span>  &nbsp;&nbsp;&nbsp;</span>				 
					</div>
	...
	@section('inline_js')
		...
		<script type="text/javascript">
			...
			function changeCards(val){
				$.ajax({
			      url: "getcardsbycardtype?name="+val,
			      success: function(data) {
			    	  data = "<option value='0'> ALL </option>"+data;
			    	  $("#card").html(data);
			    	  $('.chosen-select').trigger("chosen:updated");
