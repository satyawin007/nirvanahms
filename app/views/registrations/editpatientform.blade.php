					...
					<div class="widget-main">
											...
											<div class="col-xs-6">
												...
												<div class="form-group">
													...
													<div class="col-xs-8">
														...
														<?php 
															foreach($form_field["options"] as $key => $value){
																if(isset($form_field['value']) && $form_field['value']=='YES') {
																	echo "<label><input type='checkbox' checked='checked', name=\"".$form_field['name']."\"class='ace' value='$key'> <span class='lbl'>".$value."</span></label>&nbsp;&nbsp;";
																}
																else{
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<input class="btn btn-info" type="submit" value="UPDATE" id="submit"/>
								&nbsp; &nbsp; &nbsp;
